...
public class Twhinh200ServiceImpl implements ITwhinh200Service{
  ...
  //  @Autowired
    ...
    private String formattedDate3 = localDate.format(formatter2);
    ...
    public void test200Date(){
        //nextTwhinh200120();
        List<Twhinh200120> twhinh200120List = new ArrayList<>();
        twhinh200120List=twhinh200Repository.findByDate(this.formattedDate3);
        System.out.println(twhinh200120List.size());
        for (Twhinh200120 twh200: twhinh200120List){
            System.out.println("tOrno : ");
            System.out.println(twh200.getTOrno());
        }
    }
    @Override
